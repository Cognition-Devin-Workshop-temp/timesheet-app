...
describe('Project Routes', () => {
  ...
  describe('POST /api/projects', () => {
    test('should create new project with valid data', async () => {
      ...
      const createdProject = { id: 1, name: 'New Project', description: 'New Description', client_id: 1, start_date: '2024-01-15', status: 'active', client_name: 'Client A', created_at: '2024-01-01', updated_at: '2024-01-01' };
    ...
    test('should create project with only name (minimum required)', async () => {
  ...
  describe('PUT /api/projects/:id', () => {
    test('should update project with valid data', async () => {
      const updatedProject = { id: 1, name: 'Updated Project', description: 'Updated', client_id: 2, start_date: '2024-03-01', status: 'completed', client_name: 'Client B', created_at: '2024-01-01', updated_at: '2024-03-01' };
