...
describe('Project Routes', () => {
  ...
  describe('POST /api/projects', () => {
    ...
    test('should create project with only name', async () => {
      ...
      expect(response.status).toBe(201);
      expect(response.body.project.name).toBe('Minimal Project');
  ...
  describe('PUT /api/projects/:id', () => {
    test('should update project with valid data', async () => {
      ...
      const updatedProject = { id: 1, name: 'Updated Project', description: 'Desc', client_id: 1, start_date: '2024-01-01', status: 'completed', client_name: 'Client A', created_at: '2024-01-01', updated_at: '2024-01-15' };
