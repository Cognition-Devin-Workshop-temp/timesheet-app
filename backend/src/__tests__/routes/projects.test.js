...
describe('Project Routes', () => {
  ...
  describe('POST /api/projects', () => {
    test('should create new project with valid data', async () => {
      const newProject = { name: 'New Project', description: 'New Description', clientId: 1, startDate: '2024-01-15', status: 'active' };
      const createdProject = { id: 1, name: 'New Project', description: 'New Description', client_id: 1, start_date: '2024-01-15', status: 'active', client_name: 'Client A' };
    ...
    test('should create project with default status active', async () => {
      const newProject = { name: 'Project No Status', clientId: 1, startDate: '2024-03-01' };
      const createdProject = { id: 1, name: 'Project No Status', description: null, client_id: 1, start_date: '2024-03-01', status: 'active', client_name: 'Client A' };
    ...
    test('should return 400 for missing clientId', async () => {
      const response = await request(app)
        .post('/api/projects')
        .send({ name: 'Project', startDate: '2024-01-01' });
    ...
    test('should return 400 for invalid status', async () => {
      const response = await request(app)
        .post('/api/projects')
        .send({ name: 'Project', clientId: 1, startDate: '2024-01-01', status: 'invalid' });
    ...
    test('should return 400 if client does not belong to user', async () => {
      ...
      const response = await request(app)
        .post('/api/projects')
        .send({ name: 'Project', clientId: 999, startDate: '2024-01-01' });
    ...
    test('should handle database insert error', async () => {
      ...
      const response = await request(app)
        .post('/api/projects')
        .send({ name: 'Test Project', clientId: 1, startDate: '2024-01-01' });
  ...
  describe('PUT /api/projects/:id', () => {
    ...
    test('should update project clientId and verify ownership', async () => {
      ...
      // Second get: new client exists and belongs to user
      mockDb.get.mockImplementationOnce((query, params, callback) => {
        callback(null, { id: 2 });
      });
