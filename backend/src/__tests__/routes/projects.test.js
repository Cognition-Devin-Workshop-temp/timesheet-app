...
describe('Project Routes', () => {
  ...
  describe('POST /api/projects', () => {
    ...
    test('should create project with client assignment', async () => {
      ...
      // First get call is for client verification
      ...
      // Second get call is for retrieving the created project
      mockDb.get.mockImplementationOnce((query, params, callback) => {
        callback(null, createdProject);
      });
    ...
    test('should handle database error on client verification', async () => {
      mockDb.get.mockImplementation((query, params, callback) => {
        callback(new Error('Database error'), null);
      });
  ...
  describe('PUT /api/projects/:id', () => {
    ...
    test('should update project with client assignment', async () => {
      ...
      // Second get: verify client exists
      mockDb.get.mockImplementationOnce((query, params, callback) => {
        callback(null, { id: 2 });
      });
    ...
    test('should return 400 if updated client not found', async () => {
  ...
  describe('DELETE /api/projects', () => {
    ...
    test('should handle database error on delete all', async () => {
      mockDb.run.mockImplementation(function(query, params, callback) {
        callback.call(this, new Error('Database error'));
      });
