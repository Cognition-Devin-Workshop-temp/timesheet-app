...
describe('Project Routes', () => {
  ...
  describe('GET /api/projects', () => {
    test('should return all projects for authenticated user', async () => {
      const mockProjects = [
        { id: 1, name: 'Project A', description: 'Desc A', client_id: 1, client_name: 'Client A', start_date: '2024-01-01', status: 'active', created_at: '2024-01-01', updated_at: '2024-01-01' },
  ...
  describe('GET /api/projects/:id', () => {
    test('should return specific project', async () => {
      const mockProject = { id: 1, name: 'Project A', description: 'Desc A', client_id: 1, client_name: 'Client A', start_date: '2024-01-01', status: 'active' };
  ...
  describe('POST /api/projects', () => {
    test('should create new project with valid data', async () => {
      ...
      const createdProject = { id: 1, name: 'New Project', description: 'New Description', client_id: 1, client_name: 'Client A', start_date: '2024-01-01', status: 'active', created_at: '2024-01-01', updated_at: '2024-01-01' };
    ...
    test('should return 400 when client not found', async () => {
      ...
      const response = await request(app)
        .post('/api/projects')
        .send({ name: 'Test', clientId: 999, startDate: '2024-01-01', status: 'active' });
    ...
    test('should handle database insert error', async () => {
      ...
      const response = await request(app)
        .post('/api/projects')
        .send({ name: 'Test', clientId: 1, startDate: '2024-01-01', status: 'active' });
  ...
  describe('PUT /api/projects/:id', () => {
    test('should update project name', async () => {
      const updatedProject = { id: 1, name: 'Updated Name', description: 'Old Desc', client_id: 1, client_name: 'Client A', start_date: '2024-01-01', status: 'active' };
