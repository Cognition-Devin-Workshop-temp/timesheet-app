...
describe('Project Routes', () => {
  ...
  describe('POST /api/projects', () => {
    ...
    test('should create project with client assignment', async () => {
      const newProject = { name: 'Client Project', clientId: 5, startDate: '2024-06-01', status: 'active' };
      const createdProject = { id: 2, name: 'Client Project', client_id: 5, start_date: '2024-06-01', status: 'active', client_name: 'Client X', created_at: '2024-01-01', updated_at: '2024-01-01' };
      ...
      expect(response.status).toBe(201);
      expect(response.body.project.client_id).toBe(5);
    });
