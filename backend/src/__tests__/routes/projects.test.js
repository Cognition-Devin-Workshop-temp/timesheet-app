...
describe('Project Routes', () => {
  ...
  describe('GET /api/projects', () => {
    test('should return all projects for authenticated user', async () => {
      const mockProjects = [
        { id: 1, name: 'Project A', description: 'Desc A', status: 'active', client_name: 'Client A' },
        { id: 2, name: 'Project B', description: 'Desc B', status: 'completed', client_name: null }
      ];
  ...
  describe('POST /api/projects', () => {
    test('should create project with valid data (no client)', async () => {
      const newProject = { name: 'New Project', description: 'New Description' };
      const createdProject = { id: 1, ...newProject, status: 'active', client_id: null, client_name: null, created_at: '2024-01-01', updated_at: '2024-01-01' };
    ...
    test('should return 400 if assigned client not found', async () => {
      mockDb.get.mockImplementation((query, params, callback) => {
        callback(null, null);
      });
  ...
  describe('POST /api/projects - Error Handling', () => {
