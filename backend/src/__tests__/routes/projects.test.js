...
describe('Project Routes', () => {
  ...
  describe('POST /api/projects', () => {
    ...
    test('should create project with client assignment', async () => {
      const newProject = { name: 'Client Project', clientId: 1, startDate: '2024-03-01', status: 'active' };
      const createdProject = { id: 2, name: 'Client Project', description: null, client_id: 1, start_date: '2024-03-01', status: 'active', client_name: 'Client A', created_at: '2024-01-01', updated_at: '2024-01-01' };
      ...
      expect(response.body.project.client_name).toBe('Client A');
    });
