...
describe('Project Routes', () => {
  ...
  describe('POST /api/projects', () => {
    ...
    test('should create project with client assignment', async () => {
      ...
      // First get call verifies client ownership
      ...
      // Second get call returns the created project
      mockDb.get.mockImplementationOnce((query, params, callback) => {
        callback(null, createdProject);
      });
    ...
    test('should return 400 if assigned client does not belong to user', async () => {
      const newProject = { name: 'Project', clientId: 999 };
    ...
    test('should create project with start date', async () => {
      const newProject = { name: 'Dated Project', startDate: '2024-06-01', status: 'active' };
      const createdProject = { id: 1, name: 'Dated Project', start_date: '2024-06-01', status: 'active', client_id: null, client_name: null, created_at: '2024-01-01', updated_at: '2024-01-01' };
      ...
      expect(response.status).toBe(201);
      expect(response.body.project.start_date).toBe('2024-06-01');
    });
  ...
  describe('PUT /api/projects/:id', () => {
    test('should update project name', async () => {
      const updatedProject = { id: 1, name: 'Updated Name', description: 'Desc', client_id: null, start_date: null, status: 'active', client_name: null, created_at: '2024-01-01', updated_at: '2024-01-02' };
    ...
    test('should update project status', async () => {
      const updatedProject = { id: 1, name: 'Project', status: 'completed', created_at: '2024-01-01', updated_at: '2024-01-02' };
    ...
    test('should update project client assignment', async () => {
      const updatedProject = { id: 1, name: 'Project', client_id: 2, client_name: 'Client B', status: 'active' };
