...
describe('Project Routes', () => {
  ...
  describe('GET /api/projects', () => {
    test('should return all projects for authenticated user', async () => {
      const mockProjects = [
        { id: 1, name: 'Project A', description: 'Desc A', status: 'active', client_name: 'Client A', created_at: '2024-01-01', updated_at: '2024-01-01' },
        { id: 2, name: 'Project B', description: 'Desc B', status: 'completed', client_name: null, created_at: '2024-01-02', updated_at: '2024-01-02' }
      ];
  ...
  describe('GET /api/projects/:id', () => {
    test('should return specific project', async () => {
      const mockProject = { id: 1, name: 'Project A', description: 'Desc A', status: 'active', client_name: 'Client A' };
  ...
  describe('POST /api/projects', () => {
    test('should create new project with valid data', async () => {
      ...
      const createdProject = { id: 1, ...newProject, client_id: null, client_name: null, start_date: null, created_at: '2024-01-01', updated_at: '2024-01-01' };
    ...
    test('should create project with clientId', async () => {
      const newProject = { name: 'New Project', clientId: 1 };
      const createdProject = { id: 1, name: 'New Project', client_id: 1, client_name: 'Client A', status: 'active' };
      ...
      // Second get call: fetch created project
      mockDb.get.mockImplementationOnce((query, params, callback) => {
        callback(null, createdProject);
      });
    ...
    test('should return 400 when clientId does not belong to user', async () => {
      ...
      const response = await request(app)
        .post('/api/projects')
        .send({ name: 'New Project', clientId: 999 });
    ...
    test('should handle database error when verifying clientId', async () => {
      mockDb.get.mockImplementation((query, params, callback) => {
        callback(new Error('Database error'), null);
      });
  ...
  describe('PUT /api/projects/:id', () => {
    ...
    test('should update both name and status', async () => {
      const updatedProject = { id: 1, name: 'New Name', status: 'on-hold' };
      ...
      const response = await request(app)
        .put('/api/projects/1')
        .send({ name: 'New Name', status: 'on-hold' });
