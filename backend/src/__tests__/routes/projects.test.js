...
describe('Project Routes', () => {
  ...
  describe('POST /api/projects', () => {
    test('should create new project with valid data (no client)', async () => {
    ...
    test('should create project with client assignment', async () => {
      const newProject = { name: 'Project with Client', clientId: 1, status: 'active' };
      const createdProject = { id: 1, name: 'Project with Client', client_id: 1, status: 'active', client_name: 'Client A', created_at: '2024-01-01', updated_at: '2024-01-01' };
      ...
      // Second get call: return created project
      mockDb.get.mockImplementationOnce((query, params, callback) => {
        callback(null, createdProject);
      });
  ...
  describe('PUT /api/projects/:id', () => {
    test('should update project with valid data', async () => {
      ...
      const updatedProject = { id: 1, name: 'Updated Project', status: 'completed', client_id: null, client_name: null, created_at: '2024-01-01', updated_at: '2024-01-02' };
