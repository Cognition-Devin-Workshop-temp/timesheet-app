...
describe('Project Routes', () => {
  ...
  describe('POST /api/projects', () => {
    test('should create new project with valid data', async () => {
      ...
      const createdProject = { id: 1, ...newProject, client_id: null, client_name: null, start_date: null, status: 'active', created_at: '2024-01-01', updated_at: '2024-01-01' };
    ...
    test('should create project without optional fields', async () => {
      const newProject = { name: 'Project Without Optional' };
      const createdProject = { id: 1, name: 'Project Without Optional', description: null, client_id: null, client_name: null, start_date: null, status: 'active' };
  ...
  describe('PUT /api/projects/:id', () => {
    ...
    test('should update multiple fields', async () => {
      const updatedProject = { id: 1, name: 'New Name', description: 'New Desc', status: 'on-hold' };
      ...
      const response = await request(app)
        .put('/api/projects/1')
        .send({ name: 'New Name', description: 'New Desc', status: 'on-hold' });
  ...
  describe('DELETE /api/projects', () => {
    test('should delete all projects for user', async () => {
      ...
      expect(response.status).toBe(200);
      expect(response.body.message).toBe('All projects deleted successfully');
