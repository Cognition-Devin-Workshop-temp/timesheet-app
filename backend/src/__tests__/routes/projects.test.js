...
describe('Project Routes', () => {
  ...
  describe('GET /api/projects', () => {
    test('should return all projects for authenticated user', async () => {
      const mockProjects = [
        ...
        { id: 2, name: 'Project B', description: 'Desc B', client_id: 2, start_date: '2024-02-01', status: 'completed', client_name: 'Client B' }
      ];
  ...
  describe('POST /api/projects', () => {
    test('should create new project with valid data', async () => {
      const newProject = { name: 'New Project', description: 'New Description', clientId: 1, startDate: '2024-01-01', status: 'active' };
      const createdProject = { id: 1, name: 'New Project', description: 'New Description', client_id: 1, start_date: '2024-01-01', status: 'active', client_name: 'Client A' };
      ...
      // Second get: re-fetch created project
      mockDb.get.mockImplementationOnce((query, params, callback) => {
    ...
    test('should create project without description', async () => {
      const newProject = { name: 'Project No Desc', clientId: 1, startDate: '2024-01-01' };
      const createdProject = { id: 1, name: 'Project No Desc', description: null, client_id: 1, start_date: '2024-01-01', status: 'active', client_name: 'Client A' };
    ...
    test('should default status to active', async () => {
      const newProject = { name: 'Default Status', clientId: 1, startDate: '2024-01-01' };
      const createdProject = { id: 1, name: 'Default Status', client_id: 1, start_date: '2024-01-01', status: 'active', client_name: 'Client A' };
    ...
    test('should return 400 for missing clientId', async () => {
      const response = await request(app)
        .post('/api/projects')
        .send({ name: 'Test', startDate: '2024-01-01' });
    ...
    test('should return 400 for invalid status value', async () => {
      const response = await request(app)
        .post('/api/projects')
        .send({ name: 'Test', clientId: 1, startDate: '2024-01-01', status: 'invalid' });
    ...
    test('should return 400 if client does not belong to user', async () => {
      ...
      const response = await request(app)
        .post('/api/projects')
        .send({ name: 'Test', clientId: 999, startDate: '2024-01-01' });
    ...
    test('should handle database insert error', async () => {
      ...
      const response = await request(app)
        .post('/api/projects')
        .send({ name: 'Test', clientId: 1, startDate: '2024-01-01' });
  ...
  describe('PUT /api/projects/:id', () => {
    test('should update project name', async () => {
      const updatedProject = { id: 1, name: 'Updated Name', description: 'Desc', client_id: 1, start_date: '2024-01-01', status: 'active', client_name: 'Client A' };
      ...
      // Second get: re-fetch updated project
      mockDb.get.mockImplementationOnce((query, params, callback) => {
    ...
    test('should update project status', async () => {
      ...
      mockDb.get.mockImplementationOnce((query, params, callback) => {
        callback(null, { id: 1, name: 'Project', status: 'completed', client_name: 'Client A' });
      });
    ...
    test('should update project clientId with ownership check', async () => {
      // First get: check project exists
      mockDb.get.mockImplementationOnce((query, params, callback) => {
        callback(null, { id: 1 });
      });

      // Second get: verify new client belongs to user
      mockDb.get.mockImplementationOnce((query, params, callback) => {
        callback(null, { id: 2 });
      });
      ...
      // Third get: re-fetch updated project
      mockDb.get.mockImplementationOnce((query, params, callback) => {
    ...
    test('should return 400 if updated clientId does not belong to user', async () => {
      ...
      // Second get: new client not found
      mockDb.get.mockImplementationOnce((query, params, callback) => {
        callback(null, null);
      });
  ...
  describe('DELETE /api/projects/:id', () => {
    ...
    test('should handle database error on ownership check', async () => {
      mockDb.get.mockImplementation((query, params, callback) => {
        callback(new Error('Database error'), null);
      });
