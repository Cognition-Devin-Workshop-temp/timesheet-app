...
describe('Project Routes', () => {
  ...
  describe('POST /api/projects', () => {
    test('should create new project with valid data', async () => {
      const newProject = { name: 'New Project', description: 'New Description', status: 'active', clientId: 1, startDate: '2024-06-01' };
  ...
  describe('PUT /api/projects/:id', () => {
    ...
    test('should update project description', async () => {
      ...
      mockDb.get.mockImplementationOnce((query, params, callback) => {
        callback(null, { id: 1, name: 'Project', description: 'New Description' });
      });
    ...
    test('should update multiple fields at once', async () => {
      const updatedProject = { id: 1, name: 'New Name', description: 'New Desc', status: 'on-hold', client_id: 2, start_date: '2024-07-01' };
      ...
      const response = await request(app)
        .put('/api/projects/1')
        .send({ name: 'New Name', description: 'New Desc', status: 'on-hold', clientId: 2, startDate: '2024-07-01' });
