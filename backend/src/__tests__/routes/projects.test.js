...
describe('Project Routes', () => {
  ...
  describe('POST /api/projects', () => {
    ...
    test('should create project with client assignment', async () => {
      const newProject = { name: 'Client Project', description: 'Desc', clientId: 1, startDate: '2024-06-01', status: 'active' };
      const createdProject = { id: 1, name: 'Client Project', description: 'Desc', client_id: 1, start_date: '2024-06-01', status: 'active', client_name: 'Client A', created_at: '2024-01-01', updated_at: '2024-01-01' };
    ...
    test('should return 400 if assigned client does not exist', async () => {
      const newProject = { name: 'Bad Client Project', clientId: 999, status: 'active' };
    ...
    test('should return 400 for missing required fields', async () => {
      const response = await request(app)
        .post('/api/projects')
        .send({ description: 'No name or status' });
    ...
    test('should handle database error on insert', async () => {
      const newProject = { name: 'New Project', status: 'active' };
  ...
  describe('PUT /api/projects/:id', () => {
    test('should update project with valid data', async () => {
      ...
      const updatedProject = { id: 1, name: 'Updated Project', description: null, client_id: null, start_date: null, status: 'completed', client_name: null, created_at: '2024-01-01', updated_at: '2024-01-02' };

      // First get: ownership check, second get: return updated project
      let getCallCount = 0;
      mockDb.get.mockImplementation((query, params, callback) => {
        getCallCount++;
        if (getCallCount === 1) {
    ...
    test('should return 400 if updated client does not exist', async () => {
      // First get: project ownership check passes
