...
describe('Project Routes', () => {
  ...
  describe('GET /api/projects', () => {
    test('should return all projects for authenticated user', async () => {
      const mockProjects = [
        ...
        { id: 2, name: 'Project B', description: 'Desc B', client_id: null, start_date: null, status: 'completed', created_at: '2024-01-02', updated_at: '2024-01-02', client_name: null }
      ];
  ...
  describe('GET /api/projects/:id', () => {
    test('should return specific project', async () => {
      const mockProject = { id: 1, name: 'Project A', description: 'Desc A', client_id: 1, status: 'active', client_name: 'Client A' };
  ...
  describe('POST /api/projects', () => {
    ...
    test('should create project without optional fields', async () => {
      const newProject = { name: 'Project Without Extras' };
      const createdProject = { id: 1, name: 'Project Without Extras', description: null, client_id: null, start_date: null, status: 'active' };
    ...
    test('should return 404 when referencing non-existent client', async () => {
      mockDb.get.mockImplementation((query, params, callback) => {
        callback(null, null);
      });
