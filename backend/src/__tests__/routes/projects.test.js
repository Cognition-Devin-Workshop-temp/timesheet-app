...
describe('Project Routes', () => {
  ...
  describe('POST /api/projects', () => {
    test('should create project with valid data (all fields)', async () => {
      const newProject = { name: 'New Project', description: 'New Description', clientId: 1, startDate: '2024-06-01', status: 'active' };
      const createdProject = { id: 1, name: 'New Project', description: 'New Description', client_id: 1, start_date: '2024-06-01', status: 'active', created_at: '2024-01-01', updated_at: '2024-01-01', client_name: 'Client A' };
    ...
    test('should return 400 if specified client not found', async () => {
      mockDb.get.mockImplementation((query, params, callback) => {
        callback(null, null);
      });
  ...
  describe('PUT /api/projects/:id', () => {
    ...
    test('should return 400 if specified client not found', async () => {
      ...
      // Second get: client does not exist
      mockDb.get.mockImplementationOnce((query, params, callback) => {
        callback(null, null);
      });
    ...
    test('should handle database error when checking existence', async () => {
      mockDb.get.mockImplementation((query, params, callback) => {
        callback(new Error('Database error'), null);
      });
