...
describe('Project Routes', () => {
  ...
  describe('GET /api/projects', () => {
    test('should return all projects for authenticated user', async () => {
      const mockProjects = [
        ...
        { id: 2, name: 'Project B', description: 'Desc B', client_id: null, client_name: null, start_date: null, status: 'completed', created_at: '2024-01-02', updated_at: '2024-01-02' }
      ];
      ...
      expect(mockDb.all).toHaveBeenCalledWith(
        expect.stringContaining('SELECT projects.id'),
        ['test@example.com'],
        expect.any(Function)
      );
    });
  ...
  describe('GET /api/projects/:id', () => {
    test('should return specific project', async () => {
      const mockProject = { id: 1, name: 'Project A', description: 'Desc A', client_id: 1, client_name: 'Client A', status: 'active' };
  ...
  describe('POST /api/projects', () => {
    test('should create project with valid data including clientId, startDate, status', async () => {
      const newProject = { name: 'New Project', description: 'New Description', clientId: 1, startDate: '2024-06-01', status: 'active' };
      const createdProject = { id: 1, name: 'New Project', description: 'New Description', client_id: 1, client_name: 'Client A', start_date: '2024-06-01', status: 'active', created_at: '2024-01-01', updated_at: '2024-01-01' };
    ...
    test('should create project with only required fields (name)', async () => {
      const newProject = { name: 'Minimal Project' };
      const createdProject = { id: 1, name: 'Minimal Project', description: null, client_id: null, client_name: null, start_date: null, status: 'active', created_at: '2024-01-01', updated_at: '2024-01-01' };
