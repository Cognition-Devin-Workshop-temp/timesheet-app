...
describe('Project Routes', () => {
  ...
  describe('GET /api/projects', () => {
    test('should return all projects for authenticated user', async () => {
      const mockProjects = [
        { id: 1, name: 'Project A', description: 'Desc A', status: 'active', client_id: 1, client_name: 'Client A', start_date: '2024-01-01', end_date: null, created_at: '2024-01-01', updated_at: '2024-01-01' },
        { id: 2, name: 'Project B', description: 'Desc B', status: 'completed', client_id: 2, client_name: 'Client B', start_date: '2024-02-01', end_date: '2024-06-01', created_at: '2024-01-02', updated_at: '2024-01-02' }
      ];
  ...
  describe('GET /api/projects/:id', () => {
    test('should return specific project', async () => {
      const mockProject = { id: 1, name: 'Project A', description: 'Desc A', status: 'active', client_id: 1, client_name: 'Client A' };
  ...
  describe('POST /api/projects', () => {
    test('should create new project with valid data', async () => {
      const newProject = { name: 'New Project', description: 'New Description', clientId: 1, startDate: '2024-01-01' };
      const createdProject = { id: 1, name: 'New Project', description: 'New Description', status: 'active', client_id: 1, client_name: 'Client A', start_date: '2024-01-01', end_date: null, created_at: '2024-01-01', updated_at: '2024-01-01' };
    ...
    test('should create project with default status active', async () => {
      const newProject = { name: 'Project', clientId: 1 };
      const createdProject = { id: 1, name: 'Project', status: 'active', client_id: 1, client_name: 'Client A' };
  ...
  describe('PUT /api/projects/:id', () => {
    test('should update project with valid data', async () => {
      const updatedProject = { id: 1, name: 'Updated Project', description: 'Updated', status: 'completed', client_id: 1, client_name: 'Client A' };
      ...
      const response = await request(app)
        .put('/api/projects/1')
        .send({ name: 'Updated Project', description: 'Updated', status: 'completed' });
    ...
    test('should update only provided fields', async () => {
      const updatedProject = { id: 1, name: 'Original', status: 'on-hold', client_id: 1, client_name: 'Client A' };
