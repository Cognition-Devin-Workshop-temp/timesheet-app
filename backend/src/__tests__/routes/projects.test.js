...
describe('Project Routes', () => {
  ...
  describe('GET /api/projects', () => {
    test('should return all projects for authenticated user', async () => {
      const mockProjects = [
        { id: 1, name: 'Project A', description: 'Desc A', client_id: 1, start_date: '2024-01-01', status: 'active', created_at: '2024-01-01', updated_at: '2024-01-01', client_name: 'Client A' },
        { id: 2, name: 'Project B', description: 'Desc B', client_id: null, start_date: null, status: 'on-hold', created_at: '2024-01-02', updated_at: '2024-01-02', client_name: null }
      ];
  ...
  describe('POST /api/projects', () => {
    test('should create project with valid data', async () => {
      const newProject = { name: 'New Project', description: 'Description', status: 'active' };
      const createdProject = { id: 1, ...newProject, client_id: null, start_date: null, created_at: '2024-01-01', updated_at: '2024-01-01', client_name: null };
    ...
    test('should create project with client assignment', async () => {
      const newProject = { name: 'New Project', clientId: 1 };
      const createdProject = { id: 1, name: 'New Project', client_id: 1, status: 'active', client_name: 'Client A', created_at: '2024-01-01', updated_at: '2024-01-01' };
  ...
  describe('PUT /api/projects/:id', () => {
    test('should update project name', async () => {
      const updatedProject = { id: 1, name: 'Updated Name', status: 'active', created_at: '2024-01-01', updated_at: '2024-01-02' };
      ...
      // Second get: retrieve updated project
      mockDb.get.mockImplementationOnce((query, params, callback) => {
    ...
    test('should update project client', async () => {
      ...
      // Second get: verify new client exists
      mockDb.get.mockImplementationOnce((query, params, callback) => {
        callback(null, { id: 2 });
      });
    ...
    test('should return 400 if new client not found', async () => {
      ...
      // Second get: verify new client - not found
      mockDb.get.mockImplementationOnce((query, params, callback) => {
        callback(null, null);
      });
    ...
    test('should handle database error checking existence', async () => {
      mockDb.get.mockImplementation((query, params, callback) => {
        callback(new Error('Database error'), null);
      });
    ...
    test('should update multiple fields', async () => {
      const updatedProject = { id: 1, name: 'Updated', description: 'New desc', status: 'on-hold' };
      ...
      const response = await request(app)
        .put('/api/projects/1')
        .send({ name: 'Updated', description: 'New desc', status: 'on-hold' });
  ...
  describe('DELETE /api/projects', () => {
    ...
    test('should handle database error during delete all', async () => {
      mockDb.run.mockImplementation(function(query, params, callback) {
        callback.call(this, new Error('Delete error'));
      });
