...
router.post('/', (req, res, next) => {
  try {
    ...
    if (clientId) {
      ...
      insertProject(db, name, description, clientId || null, startDate, status, req.userEmail, res);
    }
  } catch (error) {
    next(error);
  }
  ...
  try {
    ...
    db.get(
      ...
      (err, row) => {
        ...
        // If clientId is being updated and is not null, verify the client exists
