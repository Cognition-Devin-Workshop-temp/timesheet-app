...
const ProjectsPage: React.FC = () => {
  ...
  const createMutation = useMutation({
    mutationFn: (data: { name: string; description?: string; status?: string; clientId: number; startDate?: string | null; endDate?: string | null }) =>
  ...
  const updateMutation = useMutation({
    mutationFn: ({ id, data }: { id: number; data: { name?: string; description?: string; status?: string; clientId?: number; startDate?: string | null; endDate?: string | null } }) =>
  ...
  const handleOpen = (project?: Project) => {
    if (project) {
      ...
      setFormData({ name: '', description: '', status: 'active', clientId: '', startDate: '', endDate: '' });
    }
    setError('');
    setOpen(true);
  };
