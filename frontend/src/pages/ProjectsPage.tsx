...
const ProjectsPage: React.FC = () => {
  ...
  const createMutation = useMutation({
    mutationFn: (projectData: { name: string; description?: string; client_id?: number | null; start_date?: string; status?: string }) =>
  ...
  const updateMutation = useMutation({
    mutationFn: ({ id, data }: { id: number; data: { name?: string; description?: string; client_id?: number | null; start_date?: string; status?: string } }) =>
          ...
          <DialogContent>
            ...
            <FormControl fullWidth margin="dense">
              ...
              <Select
                ...
                onChange={(e: SelectChangeEvent) => setFormData({ ...formData, client_id: e.target.value })}
                disabled={createMutation.isPending || updateMutation.isPending}
              >
                <MenuItem value="">
                  <em>None</em>
