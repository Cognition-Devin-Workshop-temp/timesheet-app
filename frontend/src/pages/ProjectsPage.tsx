...
const ProjectsPage: React.FC = () => {
  ...
  const [formData, setFormData] = useState({ name: '', description: '', clientId: 0, startDate: '', status: 'active' });
  ...
  const handleOpen = (project?: Project) => {
    if (project) {
      ...
      setFormData({ name: '', description: '', clientId: 0, startDate: '', status: 'active' });
    }
    setError('');
    setOpen(true);
  };
